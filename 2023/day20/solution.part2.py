...
def main():
    ...
    # part 2
    # note that ["sb", "nd", "ds", "hf"] -> zp -> rx
    # so cal step for 4 modules to emit LOW signal then use lcm
    import math
    ...
    while True:
        ...
        while events:
            ...
            for e in new_events:
                events.append(e)
                if e["signal"] == "LOW" and e["dest"].name in ["sb", "nd", "ds", "hf"]:
                    ans[e["dest"].name] = cnt
